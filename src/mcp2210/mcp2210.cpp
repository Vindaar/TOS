...
void PrintSPI(SPIDataTransferStatusDef status_def){

    std::cout << "Error code : " << status_def.ErrorCode << std::endl;
    std::cout << "EngineStatus : " << std::hex << status_def.SPIEngineStatus << std::endl;

    // std::cout << "byte read : " << std::hex << static_cast<int>(dummy) << std::endl;
    int nbytes = status_def.NumberOfBytesReceived; 
    std::cout << "nbytes : " << nbytes << std::endl;
    std::cout << "data : " << std::flush;
    unsigned char ch[60];
    //ch = status_def.DataReceived;
    //memset(ch, status_def.DataReceived, 60);
    ...
    // std::bitset<8> data_binary1(ch[0]);
    // std::cout << "binary data byte 0 : " << data_binary1 << std::endl;
    // std::bitset<8> data_binary2(ch[1]);
    // std::cout << "binary data byte 0 : " << data_binary2 << std::endl;
    std::cout << std::endl;
...
SPIDataTransferStatusDef SPIDataTransfer(hid_device *handle, byte* data, int length) {
    ...
    //std::cout << "ugly output data transfer " << length << std::endl;
...
SPIDataTransferStatusDef SPISendReceive(hid_device *handle, byte* data, int cmdBufferLength, int dataLength) {
	...
	// std::cout << "Calling data transfer again with dataLength as argument" << std::endl;
	// std::cout << "    dataLength " << dataLength << std::endl;
	// std::cout << "    EngineStatus " << std::hex << def.SPIEngineStatus << std::endl;
	// PrintSPI(def);
