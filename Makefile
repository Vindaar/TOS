...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mo. Nov 16 17:43:33 2015
# Project:  TOS.pro
# Template: app
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/home/schmidt/HV_FADC/VME/lib -L/home/schmidt/HV_FADC/FadcVMEReadout/lib -L/usr/lib/x86_64-linux-gnu -Wl,--no-as-needed -Wl,--rpath=/usr/local/lib -Wl,--rpath=/home/schmidt/HV_FADC/VME/lib -Wl,--rpath=/home/schmidt/HV_FADC/FadcVMEReadout/lib -Wl,--rpath=/usr/lib -lMyVME -lMyV1729a -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) tmp/TOS1.0.0/ && $(COPY_FILE) --parents include/caseHeader.h include/console.hpp include/fpga.hpp include/gui.hpp include/header.hpp include/pc.hpp include/timepix.hpp include/waitconditions.hpp tmp/TOS1.0.0/ && $(COPY_FILE) --parents src/caseFunctions.cc src/console.cpp src/fpga.cpp src/gui.cpp src/pc.cpp src/timepix.cpp src/tos.cpp src/waitconditions.cpp tmp/TOS1.0.0/ && (cd `dirname tmp/TOS1.0.0` && $(TAR) TOS1.0.0.tar TOS1.0.0 && $(COMPRESS) TOS1.0.0.tar) && $(MOVE) `dirname tmp/TOS1.0.0`/TOS1.0.0.tar.gz . && $(DEL_FILE) -r tmp/TOS1.0.0
