...
// set to zero if you want test without having the VME hardware installed
#define WITH_VME_HARDWARE								1

// Set to one if your compiler orders bitfields MSB first
#define BITFIELDS_MSB_FIRST								0

// Program constants
#define PROGRAM_NAME									"VmeControl"
#define PROGRAM_VERSION									0.91
#define PROGRAM_INI_FILE								"vmecontrol.ini"
#define MAX_MODULES										4                  /// TODO
#define MAX_CHANNELS									24
#define MAX_GROUPS										32
#define TIMER_INTERVAL_NORMAL							50
...
typedef union {
	...
	struct {
		...
		uint16_t IsInputError:1;
		uint16_t IsSpecialMode:1;
